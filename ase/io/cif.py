...
class CIFBlock(collections.abc.Mapping):
    ...
    def _does_cif_file_contain_atom_site_disorder_group_block(self):
        ...
        Addition: GRW, VicUniWellNZ, 27/5/22.
        """
    ...
    def get_unsymmetrized_structure(self, disorder_groups=-1) -> Atoms:
        ...
        disorder_groups : int, list of ints, list of strs
            This variable includes the disorder_groups you would like to read. See _get_atom_indices_in_disorder_group method for more information about this variable.
